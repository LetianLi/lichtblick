...
export const threeDee = {
  ...
  planningSceneTopic: "Planning scene topic to subscribe to",
  defaultColor: "Default color",
  defaultColorHelp: "Default color for collision objects without specified colors",
  sceneOpacity: "Scene opacity",
  sceneOpacityHelp: "Opacity multiplier applied to all collision objects in the scene",
  showCollisionObjects: "Show collision objects",
  showAttachedObjects: "Show attached objects",
  showOctomap: "Show octomap",
  serviceStatus: "Service Status",
  service: "Service",
  serviceHelp: "ROS service used to fetch the initial planning scene",
  initialScene: "Initial scene",
  initialSceneHelp: "Status of the initial planning scene fetch",
  refetch: "Refetch",
  frameId: "Frame ID",
  shapes: "Shapes",
  noShapes: "No shapes",
  showPrimitives: "Show primitives",
  showMeshes: "Show meshes",
